...
app.post("/soma", function (req, res) {
  ...
  if (isNaN(a) || isNaN(b)) {
    res
      .status(400)
      .send(
        "Parâmetros inválidos. Certifique-se de passar números para a e b."
      );
    return;
  }
...
app.post("/subtracao", function (req, res) {
  ...
  res.send(`O resultado da subtracao de ${a} e ${b} é ${resultadoSubtracao}`);
});
...
app.post("/divisao", function (req, res) {
  ...
  res.send(`O resultado da divisao de ${a} e ${b} é ${resultadoDivisao}`);
});
...
app.post("/multiplicacao", function (req, res) {
  ...
  res.send(
    `O resultado da multiplicacao de ${a} e ${b} é ${resultadoMultiplicacao}`
  );
});
